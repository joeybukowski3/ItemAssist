# ItemAssist Design System (Mintlify-Based)

This design system is adapted from Mintlify for a professional AI-powered research and decision tool.

## Core Principles
- Fast, structured outputs (not long-form docs)
- Scannable, card-based layout
- Clear hierarchy: Summary → Key Findings → Details → Supporting Data
- Built for insurance and decision workflows, not general documentation

## UI Tone
- Professional, neutral, high-trust
- Minimal marketing or decorative elements
- Focus on usability in real-world field scenarios
...
- Background: White / very light gray for readability
- Accent: Slightly stronger blue for actions
- Cards: Subtle borders for separation (not heavy shadows)
